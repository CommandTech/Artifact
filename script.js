const ARTICLES = [
      ...
      { id: 'a5', title: 'BREAKING: Secret Ballots Found in River', excerpt: 'Ambiguous location, recycled old photos, and no official statements cited.', author: 'News Wire', date: '2024-11-04', category: 'politics', flags: ['#8', '#9', '#11'], hero: '', content: `<p><em><h1>BREAKING: Secret Ballots Found in River</h1>
      ...
      { id: 'a6', title: 'Scientists Baffled by Perpetual Motion Gadget', excerpt: 'Contradicts known physics without peer review or reproducible demo.', author: 'Science Now', date: '2025-01-08', category: 'science', hero: '', content: `<p><em><h1>Scientists Baffled by Perpetual Motion Gadget: Not a Hoax, But a Conundrum</h1>
      ...
      { id: 'a7', title: 'Crypto Scheme Promises Risk-Free 30% Weekly', excerpt: 'Guaranteed returns, unnamed auditors, and a roadmap with no details.', author: 'Sponsored', date: '2025-03-14', category: 'finance', hero: '', content: `<p><em><h1>Crypto Scheme Promises Risk-Free 30% Weekly: Unpacking the Hype</h1>
        ...
        <p>The only thing this scheme is truly ensuring is a rapid, inevitable collapse. High-yield, short-term schemes like this one attract initial investors with spectacular, quick payouts, paying them with the capital from newer participants. <mark>The promoters use the three-part structure—the easy entry, the constant payouts, and the incredible growth—to make a superficial analysis appear comprehensive</mark>, but it's a simple cover for an old-fashioned swindle. Any investment here carries the near-certainty of total capital loss.</p></em></p>` },
      { id: 'a8', title: 'Tech CEO Says AI Replaced Entire Company Overnight', excerpt: 'Lack of corroborating reports; photo from years ago; no names or filings.', author: 'Contributor', date: '2025-08-30', category: 'tech', hero: '', content: `<p><em><h1>Tech CEO Says AI Replaced Entire Company Overnight</h1>
        <h2>The Executive's Startling Announcement</h2>
        <p>In an abrupt, pre-dawn video conference, the CEO of the obscure but venture-capital-rich firm, CognitoWare, announced that the company's entire non-executive workforce had been replaced by a proprietary Generative AI model named 'The Synapse.' The bold (or perhaps brash) CEO, who referred to the artificial intelligence repeatedly as the <mark>"digital mastermind"</mark> and the "firm's new cornerstone," claimed this shift had occurred literally overnight.</p>
      ...
      { id: 'a9', title: 'Ancient Herb Eliminates Debt and Stress', excerpt: 'Conflates financial advice and wellness; single testimonial as “proof.”', author: 'Staff', date: '2025-02-09', category: 'health', hero: '', content: `<p><em><h1>Ancient Herb Eliminates Debt and Stress: Miracle Cure or Modern Myth?</h1>
        ...
        <ul><mark>Over-reliance on Em Dashes—The copy is saturated with em dashes, often used for dramatic but unnecessary emphasis:</mark> "Aetherium doesn't just reduce stress—it incinerates anxiety and manifests financial freedom—all without a single lifestyle change." This technique attempts to force a sense of authority or urgency where factual data should be.</ul>
        <ul><mark>Formulaic Lists—The product's benefits are typically organized into bulleted lists with redundant phrasing:</mark></ul>
      ...
      { id: 'a10', title: 'Leaked Memo Reveals Globalist Agenda, Says Top Scientists Admitted Climate Change Was a Hoax', excerpt: 'No document link, low-res screenshot, and outlets with history of retractions.', author: 'Wire', date: '2024-12-01', category: 'politics', hero: '', content: `<p><em><h1>Leaked Memo Reveals Globalist Agenda, Says Top Scientists Admitted Climate Change Was a Hoax</h1>
      ...
      { id: 'a11', title: 'The Cost of Your Leather', excerpt: 'Your leather may not be as eco-friendly as you think.', author: 'Staff', date: '2025-04-10', category: 'enviroment', hero: '', content: `<p><em><h1>Hidden Horrors? The Shocking Environmental Cost of Your "Natural" Leather Goods</h1>
      ...
      { id: 'a12', title: 'The Hidden Intelligence of Alligators', excerpt: 'New research reveals alligators may be more intelligent than previously thought.', author: 'Staff', date: '2022-04-20', category: 'science', hero: '', content: `<p><em><h1>BREAKING: Secret Government Study Reveals Alligators Have Human-Level Intelligence, Can Learn Complex Languages</h1>
      ...
      { id: 'a13', title: 'The Salvation Army\'s Secret Agenda', excerpt: 'Whistleblowers allege the charity is not what it seems.', author: 'Staff', date: '2024-02-17', category: 'society', hero: '', content: `<p><em><h1>Is The Salvation Army a Front for a Global Shadow Government?</h1>
      ...
      { id: 'a14', title: 'The Radio Wave Danger to Airplanes', excerpt: 'Are commercial radio broadcasts interfering with airplanes?', author: 'Staff', date: '2023-03-14', category: 'technology', hero: '', content: `<p><em><h1>The Hidden Danger in the Sky: Are Commercial Radio Waves Silently Sabotaging Airplanes?</h1>
      ...
      { id: 'a15', title: 'The Post Office and the Lost Shipwrecks', excerpt: 'A hidden history connecting the postal service to sunken treasure.', author: 'Staff', date: '2025-07-30', category: 'history', hero: '', content: `<p><em><h1>Sunken Secrets: Is the Post Office Hiding a Maritime Treasure-Hunting Operation?</h1>
      ...
      { id: 'a16', title: 'Hollow Moon: The Ultimate Government Cover-Up', excerpt: 'Declassified documents suggest the moon is an artificial construct.', author: 'Staff', date: '2025-05-05', category: 'space', flags: [], hero: '', content: `<p><em><h1>Project Echo Chamber: Leaked NASA Files Suggest Moon is an Artificial Satellite</h1>
        ...
        <p>The theory also points to the Moon's perfect circular orbit and its precise size to cause a total solar eclipse as <mark>"mathematical impossibilities" in nature.</mark> "The odds are astronomical," says Dr. Orion. "It's a clear sign of intelligent design." Mainstream science, however, explains these phenomena through well-understood principles of celestial mechanics and coincidence.</p>` },
      { id: 'a17', title: 'The Flock is Watching: Are Birds Government Surveillance Drones?', excerpt: 'The "Birds Aren\'t Real" movement gains traction with new "evidence".', author: 'Staff', date: '2025-04-03', category: 'society', flags: [], hero: '', content: `<p><em><h1>Feathers and Antennas: The Case for Avian Surveillance Grows</h1>
        ...
        <p>Proponents point to "evidence" that is easily misinterpreted. <mark>"The birds sit on power lines to recharge their batteries," claims one popular online forum.</mark> "Their 'chirping' is actually data being transmitted to a central server." These claims are supported by anecdotal stories, such as people feeling "watched" by crows or finding "metallic parts" near nests, which are often just pieces of litter like bottle caps or foil.</p>
      ...
      { id: 'a18', title: 'The Squirrel Authorship Question: Was Shakespeare a Fraud?', excerpt: 'A literary historian claims to have decoded squirrel chatter into iambic pentameter.', author: 'Staff', date: '2025-01-01', category: 'history', flags: [], hero: '', content: `<p><em><h1>Bard or Beast? The Shakespearean Squirrel Conspiracy</h1>
        ...
        <p>"Using advanced audio analysis and a proprietary 'chatter-to-text' algorithm, I have successfully translated squirrel vocalizations from the Stratford-upon-Avon area," Dr. Nutworth announced at a press conference held in his garage. <mark>"The results are astonishing. I've found entire passages of 'Hamlet' and 'Macbeth' hidden in their complex squeaks and clicks."</mark></p>
      ...
      { id: 'a19', title: 'Hollow Earth: The Evidence from Below', excerpt: 'Geologists claim seismic waves prove the Earth is hollow.', author: 'Staff', date: '2023-10-15', category: 'science', flags: [], hero: '', content: `<p><em><h1>Inner Earth Calling: Seismic Data Reveals a World Beneath Our Feet</h1>
        ...
        <p>These researchers point to "P-wave shadow zones"—areas where seismic waves from earthquakes are not detected—as proof. "Conventional science says the waves are refracted by the core," says a researcher known only as "Subterra." <mark>"But we believe the waves don't pass through because there's nothing there to travel through. The core is hollow."</mark> This cherry-picks data while ignoring the S-wave shadow zones that led to the discovery of the liquid outer core in the first place.</p>
      ...
      { id: 'a20', title: 'The Mind Control Chemical in Your Tap Water', excerpt: 'Is Dihydrogen Monoxide a government pacification agent?', author: 'Staff', date: '2025-08-12', category: 'health', flags: [], hero: '', content: `<p><em><h1>Warning: Dihydrogen Monoxide in Tap Water Linked to Mass Subservience</h1>
        ...
        <p>While the physical dangers are clear, the neurological impact is the most sinister aspect of the DHMO conspiracy. Dr. Evelyn Hayes, a biochemist who was allegedly ostracized from the scientific community for her research, claims DHMO has a profound effect on brain chemistry. <mark>"Our studies indicate that prolonged exposure to DHMO leads to a decrease in cognitive resistance and a significant increase in suggestibility,"</mark> Dr. Hayes stated in a secure interview. "It effectively dampens the neural pathways associated with critical thought and rebellion, making populations more docile and easier to control."</p>
      ...
      { id: 'a21', title: 'Chemtrails: The Poison from Above', excerpt: 'What are they really spraying in our skies?', author: 'Staff', date: '2025-10-05', category: 'environment', flags: [], hero: '', content: `<p><em><h1>The Persistent Trails: Evidence of a Global Geoengineering Program Mounts</h1>
      ...
      { id: 'a22', title: 'Flat Earth: The Ultimate Deception', excerpt: 'Why the globe is a lie and the evidence is all around us.', author: 'Staff', date: '2025-11-23', category: 'science', flags: [], hero: '', content: `<p><em><h1>Seeing is Believing: The Case for a Flat, Stationary Earth</h1>
      ...
      { id: 'a23', title: 'Time Travelers Caught on Camera', excerpt: 'Photographic "evidence" suggests time travel is real.', author: 'Staff', date: '2024-10-05', category: 'history', flags: [], hero: '', content: `<p><em><h1>Anachronisms in Old Photos: Proof of Time Travelers Among Us?</h1>
      ...
      { id: 'a24', title: 'The Reptilian Elite: Who Really Rules the World?', excerpt: 'Are world leaders secretly shapeshifting lizards?', author: 'Staff', date: '2025-08-25', category: 'politics', flags: [], hero: '', content: `<p><em><h1>They Live: The Shapeshifting Reptilian Overlords Controlling Humanity</h1>
      ...
      { id: 'a25', title: 'Plants Are Conscious and Using Wi-Fi', excerpt: 'New "research" claims plants are communicating via radio waves.', author: 'Staff', date: '2025-12-15', category: 'science', flags: [], hero: '', content: `<p><em><h1>The Secret Social Network of Plants: Trees Are Conscious and Using Wi-Fi</h1>
