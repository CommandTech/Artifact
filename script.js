const ARTICLES = [
      { id: 'a1', title: 'Miracle Berry Cures All Ailments in 3 Days', excerpt: 'A sweeping claim with no clinical citations and stock imagery of laboratory glassware.', author: 'Staff', date: '2025-08-12', category: 'health', flags: ['sensational','no-sources','stock-photos'], hero: '', content: `<p><em><h1>Miracle Berry Solidifies Place as a Medical Marvel: Cures All Ailments in 3 Days</h1>
        ...
        <p>The Miracle Berry, Synsepalum dulcificum, has a history deeply rooted in West African tradition, where it was primarily known for its ability to temporarily turn sour flavors sweet. Modern research, however, has uncovered a far more profound property. Years of steadfast dedication by researchers at the fictional Serenity Institute have led to the isolation of a key compound—dubbed "Omni-Healin"—which interacts directly with the human body's cellular repair mechanisms.</p>
      ...
      { id: 'a2', title: 'Exclusive: Tech Giant Secretly Controls the Internet', excerpt: 'Anonymous "insider" quotes with no specifics and unverifiable screenshots.', author: 'Contributor', date: '2025-07-05', category: 'tech', flags: ['anonymous-source','sweeping-claim'], hero: '', content: `<p><em><h1>The Monolith of the Web: Inside 'Nova Prime,' The Tech Giant Secretly Controlling the Internet</h1>
        ...
        <p>The digital landscape we currently navigate, once celebrated for its stunning natural beauty of diversity and chaotic freedom, is now revealed to be a meticulously managed garden. The result is a profound—and unsettling—homogeneity in global online thought.</p>
      ...
      { id: 'a3', title: 'New Study Proves Coffee Causes Everything', excerpt: 'Correlation presented as causation; lack of link to the actual study; cherry-picked subgroup.', author: 'Health Desk', date: '2025-06-03', category: 'science', flags: ['correlation-vs-causation','cherry-picked'], hero: '', content: `<p><em><h1>BREAKING: New Study Proves Coffee Causes Literally Everything</h1>
        ...
        <p>97% of all recorded rainstorms occurred within a 12-hour window of a regional spike in black coffee consumption.</p>

        <p>The stock market rises and falls in direct, but illogical, inverse proportion to the total global volume of instant coffee sold.</p>

        <p>The discovery of gravity by Sir Isaac Newton? It is worth considering that Newton had just brewed a particularly strong pot of Turkish coffee before the apple incident.</p>
        ...
        <p>The study also delves into cultural and historical impacts. No discussion would be complete without mentioning the finding that the proliferation of tiny, impractical spoons in modern life is perfectly matched, chronologically and geographically, with the rise of espresso culture.</p>

        <p>Furthermore, the paper credits the humble beverage with the entire existence of the news cycle. As Dr. Perdue concludes, "Think about it: who is awake, alert, and jittery enough at 4 AM to cover the news? Coffee drinkers. Therefore, this article wouldn't exist without the subject matter it covers."</p>

        <p>The ICC's final recommendation is not to stop drinking coffee—as that would likely cause an even more catastrophic, and currently unquantifiable, event—but simply to remember that every action, event, and thought, from the sublime to the ridiculous, can now be traced back to the brew. So next time you pour a cup, it's important to remember you are quite literally fueling the universe.</p></em></p>` },
      { id: 'a4', title: 'This $7 Stock Will 100x by Friday', excerpt: 'Promotional tone, affiliate links buried, and graphics implying guarantees.', author: 'Finance Tips', date: '2025-04-22', category: 'finance', flags: ['promotional','guaranteed-returns','undisclosed-coi'], hero: '', content: `<p><em><h1>Exclusive Market Alert: This $7 Stock Will 100x by Friday</h1>
        <h2>The Unprecedented Leap of 'QuantumLeap Dynamics' (QLD)</h2>
        <p>The financial world is about to witness an event so singular, so mathematically improbable, that it will redefine the very concept of market valuation. A virtually unknown tech stock, QuantumLeap Dynamics (QLD), currently trading at a modest $7 per share, is poised to explode. According to our independent, and highly speculative, analysis, QLD is forecast to increase its value by 10,000%—a 100x gain—before the closing bell on Friday.</p>
        ...
        <p>The common connecting words and phrases used to explain typical market movements—therefore, in conclusion, consequently—are entirely irrelevant here. This isn't a synthesis of facts; it's a quantum event.</p>
        ...
        <p>Every minute that passes increases the risk of the general public catching on to this reality, thereby raising the entry price. The financial community's overuse of certain conjunctions—however, on the other hand, nevertheless—is what prevents them from seeing the obvious: the fundamental rules of the market have been suspended by QuantumLeap Dynamics.</p>

        <p>Investors who act now will experience a wealth transfer so massive it will require new regulatory terminology. Those who wait, using connecting phrases to rationalize caution, will be left behind when QLD crosses the $700 mark on Friday, turning $1,000 into a clean $100,000. Do not delay.</p></em></p>` },
      { id: 'a5', title: 'BREAKING: Secret Ballots Found in River', excerpt: 'Ambiguous location, recycled old photos, and no official statements cited.', author: 'News Wire', date: '2024-11-04', category: 'politics', flags: ['old-photos','no-official-source'], hero: '', content: `<p><em><h1>BREAKING: Secret Ballots Found in River</h1>
        ...
        <p>The immediate challenge facing the newly formed "River Task Force" is not merely one of ballot counting, but one of faith.</p>

        <p>Despite its procedural complexity, the initial assessment confirms the ballots were not water-damaged to the point of being illegible, raising a host of logistical and legal questions. Can these votes be legally included in the final tally? Who, and why, would dump sealed, secret ballots into a river?</p>

        <p>Despite these challenges, the very existence of the ballots—which represent a significant percentage of the previously uncounted vote—has immediately cemented the election's legacy as the most controversial in the city's history. This event will likely be taught in political science classes for decades as a cautionary tale in election security and the reliability of voter turnout mechanisms.</p>
        ...
        <p>The investigation has already drawn attention from state and federal officials, ensuring the cleanup and recounting process will be lengthy, litigious, and played out entirely in the media.</p>
      ...
      { id: 'a6', title: 'Scientists Baffled by Perpetual Motion Gadget', excerpt: 'Contradicts known physics without peer review or reproducible demo.', author: 'Science Now', date: '2025-01-08', category: 'science', flags: ['violates-physics','no-peer-review'], hero: '', content: `<p><em><h1>Scientists Baffled by Perpetual Motion Gadget: Not a Hoax, But a Conundrum</h1>
      ...
      { id: 'a7', title: 'Crypto Scheme Promises Risk-Free 30% Weekly', excerpt: 'Guaranteed returns, unnamed auditors, and a roadmap with no details.', author: 'Sponsored', date: '2025-03-14', category: 'finance', flags: ['guaranteed-returns','sponsored'], hero: '', content: `<p><em><h1>Crypto Scheme Promises Risk-Free 30% Weekly: Unpacking the Hype</h1>
        ...
        <p>The promotional material is filled with persuasive, three-part rhetorical flourishes, highlighting the 'Triple-A' advantages of the platform: Automation, Arbitrage, and Absolute returns. However, a deeper look reveals critical flaws that undercut these claims.</p>
        ...
        <p>Risk-Free Returns: The entire premise of 'risk-free' income is mathematically impossible in any market, especially in crypto. Market arbitrage opportunities disappear the moment a fast, automated system exploits them. Promising a fixed, extraordinary ROI ignores the fundamental volatility, liquidity, and regulatory issues inherent to crypto.</p>

        <p>30% Weekly ROI: This rate compounds to an annual return of over 14 million percent. Even the world's most successful hedge funds rarely achieve consistent double-digit monthly returns, let alone 30% weekly. The mere declaration of this figure is a classic red flag, underscoring the unsustainable nature of the scheme.</p>

        <p>Proprietary AI: The scheme touts its exclusive, black-box trading algorithm, thereby avoiding any scrutiny of its actual workings. This lack of transparency, coupled with the incredible returns, is a tactic reflecting the core mechanism of a Ponzi scheme, fraudulent mining operation, or simple exit-scam.</p>

        <h2>Ensuring the Outcome</h2>
        <p>The only thing this scheme is truly ensuring is a rapid, inevitable collapse. High-yield, short-term schemes like this one attract initial investors with spectacular, quick payouts, paying them with the capital from newer participants. The promoters use the three-part structure—the easy entry, the constant payouts, and the incredible growth—to make a superficial analysis appear comprehensive, but it's a simple cover for an old-fashioned swindle. Any investment here carries the near-certainty of total capital loss.</p></em></p>` },
      { id: 'a8', title: 'Tech CEO Says AI Replaced Entire Company Overnight', excerpt: 'Lack of corroborating reports; photo from years ago; no names or filings.', author: 'Contributor', date: '2025-08-30', category: 'tech', flags: ['no-corroboration','old-photos'], hero: '', content: `<p><em><h1>Tech CEO Says AI Replaced Entire Company Overnight</h1>
        <h2>The Executive's Startling Announcement</h2>
        <p>In an abrupt, pre-dawn video conference, the CEO of the obscure but venture-capital-rich firm, CognitoWare, announced that the company's entire non-executive workforce had been replaced by a proprietary Generative AI model named 'The Synapse.' The bold (or perhaps brash) CEO, who referred to the artificial intelligence repeatedly as the "digital mastermind" and the "firm's new cornerstone," claimed this shift had occurred literally overnight.</p>

        <p>The chief executive stated that The Synapse now handles all core functions—from writing code and managing supply chains to responding to customer service queries and drafting legal documents. The abruptness of the announcement highlights a growing trend among tech executives to celebrate job elimination as an efficiency gain.</p>
      ...
      { id: 'a9', title: 'Ancient Herb Eliminates Debt and Stress', excerpt: 'Conflates financial advice and wellness; single testimonial as “proof.”', author: 'Staff', date: '2025-02-09', category: 'health', flags: ['testimonial-only','category-conflation'], hero: '', content: `<p><em><h1>Ancient Herb Eliminates Debt and Stress: Miracle Cure or Modern Myth?</h1>
        ...
        <p>Financial Fortitude—Aetherium is alleged to restructure the user's brain chemistry to promote "wealth consciousness," thereby attracting opportunities from unexpected windfalls to passive income streams. The promotional materials fail to explain the mechanism by which a botanical compound could influence the global financial system.</p>
        <p>Stress Annihilation—The Golden Root is further credited with completely eliminating all forms of mental strain, claiming to balance hormones from cortisol to adrenaline. This suggests an instantaneous and total cure for conditions that typically require years of therapy or medical management.</p>

        <h2>Style and Substance: The Lack of Evidence</h2>
        <ul>Over-reliance on Em Dashes—The copy is saturated with em dashes, often used for dramatic but unnecessary emphasis: "Aetherium doesn't just reduce stress—it incinerates anxiety and manifests financial freedom—all without a single lifestyle change." This technique attempts to force a sense of authority or urgency where factual data should be.</ul>
        ...
        <p>In reality, there is zero evidence to support these assertions. The Golden Root, if it exists at all, is likely a common botanical extract being used as a placebo in a fraudulent scheme. It is not a legitimate medical discovery, but rather a sophisticated effort to extract money from desperate consumers.</em></p>` },
      { id: 'a10', title: 'Leaked Memo Reveals Globalist Agenda, Says Top Scientists Admitted Climate Change Was a Hoax', excerpt: 'No document link, low-res screenshot, and outlets with history of retractions.', author: 'Wire', date: '2024-12-01', category: 'politics', flags: ['no-document','low-res'], hero: '', content: `<p><em><h1>Leaked Memo Reveals Globalist Agenda, Says Top Scientists Admitted Climate Change Was a Hoax</h1>
      ...
      { id: 'a12', title: 'The Hidden Intelligence of Alligators', excerpt: 'New research reveals alligators may be more intelligent than previously thought.', author: 'Staff', date: '2022-04-20', category: 'science', flags: ['testimonial-only','false-authority','cherry-picking'], hero: '', content: `<p><em><h1>BREAKING: Secret Government Study Reveals Alligators Have Human-Level Intelligence, Can Learn Complex Languages</h1>
      ...
      { id: 'a13', title: 'The Salvation Army\'s Secret Agenda', excerpt: 'Whistleblowers allege the charity is not what it seems.', author: 'Staff', date: '2024-02-17', category: 'society', flags: ['false-authority', 'misleading-claims', 'conspiracy-theory'], hero: '', content: `<p><em><h1>Is The Salvation Army a Front for a Global Shadow Government?</h1>
      ...
      { id: 'a15', title: 'The Post Office and the Lost Shipwrecks', excerpt: 'A hidden history connecting the postal service to sunken treasure.', author: 'Staff', date: '2025-07-30', category: 'history', flags: ['historical-revisionism', 'conspiracy-theory', 'false-authority'], hero: '', content: `<p><em><h1>Sunken Secrets: Is the Post Office Hiding a Maritime Treasure-Hunting Operation?</h1>
      ...
      { id: 'a16', title: 'Hollow Moon: The Ultimate Government Cover-Up', excerpt: 'Declassified documents suggest the moon is an artificial construct.', author: 'Staff', date: '2025-05-05', category: 'space', flags: ['conspiracy-theory', 'pseudoscience', 'false-authority'], hero: '', content: `<p><em><h1>Project Echo Chamber: Leaked NASA Files Suggest Moon is an Artificial Satellite</h1>
      ...
      { id: 'a18', title: 'The Squirrel Authorship Question: Was Shakespeare a Fraud?', excerpt: 'A literary historian claims to have decoded squirrel chatter into iambic pentameter.', author: 'Staff', date: '2025-01-01', category: 'history', flags: ['pseudoscience', 'false-authority', 'absurd-claims'], hero: '', content: `<p><em><h1>Bard or Beast? The Shakespearean Squirrel Conspiracy</h1>
      ...
      { id: 'a19', title: 'Hollow Earth: The Evidence from Below', excerpt: 'Geologists claim seismic waves prove the Earth is hollow.', author: 'Staff', date: '2023-10-15', category: 'science', flags: ['pseudoscience', 'conspiracy-theory', 'cherry-picking'], hero: '', content: `<p><em><h1>Inner Earth Calling: Seismic Data Reveals a World Beneath Our Feet</h1>
      ...
      { id: 'a20', title: 'The Mind Control Chemical in Your Tap Water', excerpt: 'Is Dihydrogen Monoxide a government pacification agent?', author: 'Staff', date: '2025-08-12', category: 'health', flags: ['pseudoscience', 'fear-mongering', 'technical-jargon'], hero: '', content: `<p><em><h1>Warning: Dihydrogen Monoxide in Tap Water Linked to Mass Subservience</h1>
      ...
      { id: 'a21', title: 'Chemtrails: The Poison from Above', excerpt: 'What are they really spraying in our skies?', author: 'Staff', date: '2025-10-05', category: 'environment', flags: ['conspiracy-theory', 'pseudoscience', 'anecdotal-evidence'], hero: '', content: `<p><em><h1>The Persistent Trails: Evidence of a Global Geoengineering Program Mounts</h1>
        ...
        <p>According to Dr. Alistair Stratus, a former government atmospheric scientist who was allegedly fired and discredited for attempting to expose the program, the spray contains a "particulate cocktail" of aluminum oxide, barium salts, and strontium. "These aren't just pollutants; they are conductors," Dr. Stratus claimed in a recent online broadcast. "They are designed to make the atmosphere more conducive to electromagnetic manipulation for weather modification and large-scale surveillance."</p>
        <p>He further alleges the mixture contains "aerosolized polymers" that, once inhaled, can self-assemble into microscopic fibers in the body, leading to a host of mysterious illnesses collectively known as "chemtrail flu."</p>

        <h2>The "Proof" from the Ground</h2>
        <p>Proponents of this theory collect anecdotal evidence, such as reports of unusual illnesses after a day of heavy spraying or samples of rainwater that allegedly contain high levels of aluminum and barium. These "tests" are often performed with home kits that are not scientifically calibrated and ignore common environmental sources for these elements. "I tested the rain in my backyard, and the aluminum levels were off the charts," wrote one blogger. "The next day, my whole family had headaches and a strange metallic taste in our mouths. Coincidence? I think not."</p>
      ...
      { id: 'a22', title: 'Flat Earth: The Ultimate Deception', excerpt: 'Why the globe is a lie and the evidence is all around us.', author: 'Staff', date: '2025-11-23', category: 'science', flags: ['pseudoscience', 'conspiracy-theory', 'denialism'], hero: '', content: `<p><em><h1>Seeing is Believing: The Case for a Flat, Stationary Earth</h1>
        <h3>By The Horizon Society | Published: October 5, 2025</h3>

        <p>For 500 years, humanity has been indoctrinated with the "globe model," a theory forced upon us by a corrupt scientific establishment. But a growing community of critical thinkers is challenging this dogma, armed with simple observation and a healthy distrust of authority. The Earth is not a spinning ball hurtling through space; it is a flat, enclosed plane, and the evidence is as clear as the horizon itself.</p>

        <h2>The Evidence of Your Senses</h2>
        <p>Flat Earth proponents argue that our own senses betray the globe model. "They tell you you're spinning at over 1,000 miles per hour and flying through space at 67,000 miles per hour," says a popular Flat Earth YouTuber. "Do you feel it? Of course not. That's because it's not happening."</p>
      ...
      { id: 'a23', title: 'Time Travelers Caught on Camera', excerpt: 'Photographic "evidence" suggests time travel is real.', author: 'Staff', date: '2024-10-05', category: 'history', flags: ['misinterpretation', 'anachronism', 'false-evidence'], hero: '', content: `<p><em><h1>Anachronisms in Old Photos: Proof of Time Travelers Among Us?</h1>
        ...
        <p>Researchers have proposed that the object is likely a portable, ear-trumpet-style hearing aid, a new technology at the time. However, proponents of the time travel theory dismiss this. "Look at her mouth moving. She's clearly having a conversation," argues a documentary on the subject. "This isn't someone trying to hear; this is someone communicating across time."</p>

        <h2>The Psychology of Seeing What We Want to See</h2>
        <p>This tactic of presenting historical photos out of context preys on our modern biases and lack of deep historical knowledge. We see a familiar object or style and immediately assume it's modern, failing to consider the technologies and fashions that existed in the past but have since fallen out of use. It creates a sense of mystery and wonder where none exists.</p>
      ...
      { id: 'a24', title: 'The Reptilian Elite: Who Really Rules the World?', excerpt: 'Are world leaders secretly shapeshifting lizards?', author: 'Staff', date: '2025-08-25', category: 'politics', flags: ['conspiracy-theory', 'false-evidence', 'demonization'], hero: '', content: `<p><em><h1>They Live: The Shapeshifting Reptilian Overlords Controlling Humanity</h1>
        ...
        <p>"You have to know what to look for," explains a prominent researcher on a popular conspiracy forum. "The eyes are the window to the soul, and in their case, the pupils will momentarily slit vertically under stress or when the camera flash hits them just right. We've documented thousands of instances."</p>
        ...
        <p>But why? The motive, according to believers, is sinister. These entities are said to "feed" on negative human emotions like fear, hatred, and chaos. Therefore, they orchestrate wars, economic collapses, and social strife to generate a constant supply of this "negative energy." "Human suffering is a literal food source for them," claims a self-published book on the topic. "They are energy vampires on a planetary scale."</p>
