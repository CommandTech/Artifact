const ARTICLES = [
      { id: 'a1', title: 'Miracle Berry Cures All Ailments in 3 Days', excerpt: 'A sweeping claim with no clinical citations and stock imagery of laboratory glassware.', author: 'Staff', date: '2025-08-12', category: 'health', flags: ['sensational','no-sources','stock-photos'], content: `<p><em><h1>Miracle Berry Solidifies Place as a Medical Marvel: Cures All Ailments in 3 Days</h1>
...
<p>The ICC's final recommendation is not to stop drinking coffee—as that would likely cause an even more catastrophic, and currently unquantifiable, event—but simply to remember that every action, event, and thought, from the sublime to the ridiculous, can now be traced back to the brew. So next time you pour a cup, it's important to remember you are quite literally fueling the universe.</p></em></p>` },
      { id: 'a4', title: 'This $7 Stock Will 100x by Friday', excerpt: 'Promotional tone, affiliate links buried, and graphics implying guarantees.', author: 'Finance Tips', date: '2025-04-22', category: 'finance', flags: ['promotional','guaranteed-returns','undisclosed-coi'], content: `<p><em><h1>Exclusive Market Alert: This $7 Stock Will 100x by Friday</h1>
...
<p>Investors who act now will experience a wealth transfer so massive it will require new regulatory terminology. Those who wait, using connecting phrases to rationalize caution, will be left behind when QLD crosses the $700 mark on Friday, turning $1,000 into a clean $100,000. Do not delay.</p></em></p>` },
      { id: 'a5', title: 'BREAKING: Secret Ballots Found in River', excerpt: 'Ambiguous location, recycled old photos, and no official statements cited.', author: 'News Wire', date: '2024-11-04', category: 'politics', flags: ['old-photos','no-official-source'], content: `<p><em><h1>BREAKING: Secret Ballots Found in River</h1>
...
<p>The immediate future of the A-Machine is a continuous loop of testing and debate. Not only does the device threaten to overturn physics textbooks, but its potential for practical application is immense. If validated, the A-Machine would solve global energy crises overnight, leading to an entirely new era of technology. It is not just about a spinning wheel; it's about a future powered without fuel. The institute, however, has cautioned the public against premature excitement, stating that the baffling nature of the device requires a cautious, methodical approach.</p></em></p>` },
      { id: 'a7', title: 'Crypto Scheme Promises Risk-Free 30% Weekly', excerpt: 'Guaranteed returns, unnamed auditors, and a roadmap with no details.', author: 'Sponsored', date: '2025-03-14', category: 'finance', flags: ['guaranteed-returns','sponsored'], content: `<p><em><h1>Crypto Scheme Promises Risk-Free 30% Weekly: Unpacking the Hype</h1>
...
<p>The only thing this scheme is truly ensuring is a rapid, inevitable collapse. High-yield, short-term schemes like this one attract initial investors with spectacular, quick payouts, paying them with the capital from newer participants. The promoters use the three-part structure—the easy entry, the constant payouts, and the incredible growth—to make a superficial analysis appear comprehensive, but it's a simple cover for an old-fashioned swindle. Any investment here carries the near-certainty of total capital loss.</p></em></p>` },
      { id: 'a8', title: 'Tech CEO Says AI Replaced Entire Company Overnight', excerpt: 'Lack of corroborating reports; photo from years ago; no names or filings.', author: 'Contributor', date: '2025-08-30', category: 'tech', flags: ['no-corroboration','old-photos'], content: `<p><em><h1>Tech CEO Says AI Replaced Entire Company Overnight</h1>
...
<p>Some critics argue that this move is less about efficiency and more about appealing to shareholders who reward cost-cutting. The CEO's overly repetitive use of terms like "digital mastermind," "new cornerstone," and "intelligent oracle" for the AI—instead of simply referring to the technology or the system—demonstrates a superficial attempt to personify and validate a premature and likely unsustainable technological shift. The key player in this narrative isn't the AI; it is the executive who has prioritized short-term optics over long-term operational stability. The ultimate success or failure of CognitoWare will serve as a stark case study in the real-world limitations of overzealous AI adoption.</p></em></p>` },
      { id: 'a9', title: 'Ancient Herb Eliminates Debt and Stress', excerpt: 'Conflates financial advice and wellness; single testimonial as “proof.”', author: 'Staff', date: '2025-02-09', category: 'health', flags: ['testimonial-only','category-conflation'], content: `<p><em><h1>Ancient Herb Eliminates Debt and Stress: Miracle Cure or Modern Myth?</h1>
